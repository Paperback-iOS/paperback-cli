...
paperback-cli/1.2.0 darwin-x64 node-v15.3.0
...
_See code: [src/commands/bundle.ts](https://github.com/FaizanDurrani/paperback-cli/blob/v1.2.0/src/commands/bundle.ts)_
...
_See code: [src/commands/serve.ts](https://github.com/FaizanDurrani/paperback-cli/blob/v1.2.0/src/commands/serve.ts)_
<!-- commandsstop -->
